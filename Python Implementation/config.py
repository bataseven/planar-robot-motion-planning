CONFIG = {"link_1_length": 38, # Length of the first link of the robot
          ...
          "link_discretization_param": 2, # Smallest length of the link to check for collision
          "angle_discretization_param": 10, # Smallest angle of a link to check for collision
